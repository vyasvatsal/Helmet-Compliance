...
# ---------------------- Alarm Stub ----------------------
def play_alarm():
    st.warning("🚨 Violation detected! (Sound not supported on Streamlit interface)")
...
st.sidebar.markdown(
    ...
    <h2 style='text-align:center; color:yellow;'>Real-time Helmet Compliance Detection</h2>
    """,
    ...
    try:
        while cap.isOpened():
            ...
            for cls_id, conf, (x1, y1, x2, y2) in detections:
                ...
                if cls_id == 1:
                    color = (0, 255, 0)  # ON. Helmet
                else:
                    color = (0, 0, 255)  # NO Helmet
